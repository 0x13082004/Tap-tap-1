...
async function walletSendCallsTap({ counter }) {
  ...
  // NOTE: Don't block on a manual ETH-balance check.
  // Some wallets/hosts may sponsor gas or use smart accounts.
  ...
  const req = {
    ...
    // Many hosts (including Farcaster Wallet) execute `wallet_sendCalls` sequentially,
    // not atomically. Setting this to `false` improves compatibility.
